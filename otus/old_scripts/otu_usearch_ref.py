...
def run(args):
    ...
    main_dir        = "/groups/vampsweb/"+args.site+"/otus/"+args.prefix
    ...
    calcnode_cmd = ["/groups/vampsweb/"+args.site+"/seqinfobin/calcnodes", '-t', str(facount), '-n', str(cluster_nodes), '-f', '1']
    ...
    for line in lines:
        ...
        fastasampler_cmd = "/groups/vampsweb/"+args.site+"/seqinfobin/fastasampler"
        fastasampler_cmd += ' -n '
        ...
        vsearch_list = ["/groups/vampsweb/"+args.site+"/seqinfobin/vsearch"]
